    ...
    <div className="min-h-screen flex items-center justify-center bg-transparent">
      ...
      >
        ...
        <input
          ...
          className="w-full mb-4 p-3 rounded-md bg-gray-900 bg-opacity-30 border border-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400"
          disabled={isLoading}
        />
